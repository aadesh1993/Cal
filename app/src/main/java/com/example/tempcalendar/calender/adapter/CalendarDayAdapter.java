package com.example.tempcalendar.calender.adapter;
...
import com.example.tempcalendar.calender.utils.EventDayUtils;
...
class CalendarDayAdapter extends ArrayAdapter<Date> {
    ...
    public View getView(int position, View view, @NonNull ViewGroup parent) {
        ...
        LinearLayout childLayout = (LinearLayout) view.findViewById(R.id.child_layout);
        ...
        if (dayIcon != null) {
            loadIcon(dayIcon, day,childLayout);
        }

        setLabelColors(dayLabel, day,childLayout);

        dayLabel.setText(String.valueOf(day.get(Calendar.DAY_OF_MONTH)));
        return view;
    }

    private void setLabelColors(TextView dayLabel, Calendar day,LinearLayout child) {
        ...
        if (isEventDayWithLabelColor(day)) {
            DayColorsUtils.setCurrentMonthDayColors(day, mToday, dayLabel, mCalendarProperties,child,context);
            return;
        }
    ...
    private void loadIcon(ImageView dayIcon, Calendar day,LinearLayout child) {
        ...
        Stream.of(mCalendarProperties.getEventDays()).filter(eventDate ->
            ...
            if (istoday(day)){
                ImageUtils.loadImage(dayIcon, ContextCompat.getDrawable(context, R.drawable.light_circle));
            }else {
                ImageUtils.loadImage(dayIcon, ContextCompat.getDrawable(context, R.drawable.dark_circle));
            }
