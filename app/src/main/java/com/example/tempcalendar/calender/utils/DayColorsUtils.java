package com.example.tempcalendar.calender.utils;
...
public class DayColorsUtils {
    ...
    public static void setCurrentMonthDayColors(Calendar day, Calendar today, TextView dayLabel,
                                                CalendarProperties calendarProperties, LinearLayout child, Context context) {
        if (today.equals(day)) {
            setTodayColors(dayLabel, calendarProperties, child, context);
            ...
            setWeekendDayColors(dayLabel,calendarProperties);
        } else {
            setNormalDayColors(dayLabel, calendarProperties);
        }
    }

    private static void setTodayColors(TextView dayLabel, CalendarProperties calendarProperties, LinearLayout child, Context context) {
        setDayColors(dayLabel, calendarProperties.getTodayLabelColor(), Typeface.BOLD,
                R.drawable.background_transparent);

        if (child != null && context != null)
            child.setBackground(ContextCompat.getDrawable(context, R.drawable.red_circle_calendar));
    ...
    private static void setWeekendDayColors(TextView dayLabel, CalendarProperties calendarProperties) {
        setDayColors(dayLabel, calendarProperties.getDisabledDaysLabelsColor(), Typeface.NORMAL,
                R.drawable.background_transparent);
    }
