...
import com.example.tempcalendar.calender.utils.DirectionalRect;
...
public class DayView extends ViewGroup {
    ...
    void setEventRects(int firstDividerTop, float minuteHeight, int dividerStart, int dividerEnd) {
        ...
        for (int i = 0; i < filteredEventViews.size(); i++) {
            ...
            int top = firstDividerTop + topOffset + dividerHeight;
            int bottom = top + (int) (duration * minuteHeight) - 0 * 2 - dividerHeight;
